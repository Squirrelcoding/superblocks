    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider registryLookup, RecipeOutput exporter) {
        return new RecipeProvider(registryLookup, exporter) {
            ...
            public void buildRecipes() {
                ...
                shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CONDENSED_DIRT) // You can also specify an int to produce more than one
                        .requires(Items.DIRT, 9) // You can also specify an int to require more than one, or a tag to accept multiple things
